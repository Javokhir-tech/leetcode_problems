...
//    }
//
//    public boolean checkEdges(int src, int dest) {
//        for (var vertex : vertices.get(src)) {
//            if (vertex == dest) return true;
//        }
//        return false;
//    }
//
//    public boolean checkRoutes(int src, int dest) {
//        var isVisitedSrc = new boolean[vertices.size()];
//        var srcQ = new LinkedList<Integer>();
//        var isVisitedDest = new boolean[vertices.size()];
//        var destQ = new LinkedList<Integer>();
//        isVisitedSrc[src] = true;
//        isVisitedDest[dest] = true;
//    }
//}
